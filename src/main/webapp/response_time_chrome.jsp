...
<body class="center-align">
	...
	ResponseTime outboundPage = responseTimeChrome.outboundJourney();
	ResponseTime inboundPage = responseTimeChrome.inboundJourney();
	ResponseTime loadTimeInsurance = responseTimeChrome.insuranceJourney();
	ResponseTime loginPage = responseTimeChrome.userLoginJourney();
